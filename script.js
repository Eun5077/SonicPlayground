...
document.querySelectorAll(".tool-btn").forEach(btn => {
  btn.addEventListener("click", () => {
    ...
    const ballEnvelopePanel = document.getElementById("ball-envelope-panel");
    if (ballEnvelopePanel) {
      ballEnvelopePanel.style.display = tool === "ball" ? "block" : "none";
    }
...
function initBallEnvelopeUI() {
  ...
  attackSlider.addEventListener("input", (e) => {
    ballEnvelopeByType[currentEnvelopeType].attack = parseFloat(e.target.value);
  });
  decaySlider.addEventListener("input", (e) => {
    ballEnvelopeByType[currentEnvelopeType].decay = parseFloat(e.target.value);
  });
  sustainSlider.addEventListener("input", (e) => {
    ballEnvelopeByType[currentEnvelopeType].sustain = parseFloat(e.target.value);
  });
  releaseSlider.addEventListener("input", (e) => {
    ballEnvelopeByType[currentEnvelopeType].release = parseFloat(e.target.value);
  });
